...
| **서울** (665 노선 · 38,534 구간) | **조회만** — 운영 1만/일이라 수집은 152배 부족 | 시각표 파일 + `realtimeStationArrival/ALL`(전 노선 도착 일괄 수집) |

서울 버스 도착정보의 출처는
[서울특별시 「서울특별시_버스도착정보조회 서비스」](https://www.data.go.kr/data/15000314/openapi.do)이며,
[공공누리 제1유형(출처표시)](https://www.kogl.or.kr/info/license.do)에 따라 이용한다.
제3자 권리가 포함될 수 있으며 자세한 고지는 [`NOTICE.md`](NOTICE.md)를 따른다.
